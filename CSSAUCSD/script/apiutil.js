...
(function(window){
    ...
    u.css = function(el, css){
        if(!u.isElement(el)){
            console.warn('$apiutil.css Function need el param, el param must be DOM Element');
            return;
        }
    ...
    u.cssVal = function(el, prop){
        if(!u.isElement(el)){
            console.warn('$apiutil.cssVal Function need el param, el param must be DOM Element');
            return;
        }
        if(arguments.length === 2){
